...
export const SAMPLE_MEMORIES: CompletedMission[] = [
  ...
  },
  {
    ...
    mission: {
      id: '6',
      title: 'A Special Day, Just for Us',
      description: 'Make your anniversary unforgettable.',
      category: 'travel' as MissionCategory,
      tags: ['anniversary', 'relaxation', 'travel'],
      imageUrl: 'https://i.postimg.cc/85GZw0Wy/IMG-5490.jpg',
      isPremium: false,
    },
    photoUrl: 'https://i.postimg.cc/85GZw0Wy/IMG-5490.jpg',
    user1Message: 'This trip was so perfect. I love you.',
    user2Message: "Every moment with you is special. Let's come back here again!",
